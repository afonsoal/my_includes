/*
 * NewMesh_3D_interpolated_interpolated.cpp
 *
...
#include "NewMesh_3D_interpolated_interpolated.h"

using namespace dealii;


NewMesh_3D_interpolated::NewMesh_3D_interpolated() {}
void NewMesh_3D_interpolated::reinit()
{
...
void NewMesh_3D_interpolated::set_variables(const std::vector<Point<3> > & _support_points,
...
void NewMesh_3D_interpolated::set_new_mesh
...
void NewMesh_3D_interpolated::create_new_triangulation (Triangulation<3> &tria)
{
...
void NewMesh_3D_interpolated::set_triangulation_indices (Triangulation<3> &tria) {
	int count_cell = 0;
